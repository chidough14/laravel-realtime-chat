...
import { AttachmentPreviewModalProps } from '@/types'
import { Dialog, DialogPanel, Transition, TransitionChild } from '@headlessui/react'
import { ChevronLeftIcon, ChevronRightIcon, PaperClipIcon } from '@heroicons/react/16/solid'
            ...
            >
              ...
              >
                <button
                  ...
                  hover:bg-black/10 transition flex items-center justify-center text-gray-100 z-40'
                >
                ...
                <div className='relative group h-full'>
                  {
                    currentIndex > 0 && (
                      ...
                      flex items-center justify-center w-16 h-16 left-4 top-1/2 
...

                  {
                    attachment && (
                      <div className='flex items-center justify-center w-full h-full p-3'>
                        {
                          isImage(attachment) && (
                            <img src={attachment.url} alt="attachment" className='max-w-full max-h-full' />
                          )
                        }
